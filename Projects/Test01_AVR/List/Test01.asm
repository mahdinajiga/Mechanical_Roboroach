...
; 0000 0030 DDRD=0x00;
	OUT  0xA,R30
; 0000 0031 
; 0000 0032 TCCR0A=0x00;
	OUT  0x24,R30
; 0000 0033 TCCR0B=0x00;
	OUT  0x25,R30
...
; 0000 0043 ASSR=0x00;
	STS  182,R30
; 0000 0044 TCCR2A=0x00;
	STS  176,R30
; 0000 0045 TCCR2B=0x00;
	STS  177,R30
; 0000 0046 TCNT2=0x00;
	STS  178,R30
; 0000 0047 OCR2A=0x00;
	STS  179,R30
; 0000 0048 OCR2B=0x00;
	STS  180,R30
; 0000 0049 
; 0000 004A EICRA=0x00;
	STS  105,R30
; 0000 004B EIMSK=0x00;
	OUT  0x1D,R30
; 0000 004C PCICR=0x00;
	STS  104,R30
; 0000 004D 
; 0000 004E TIMSK0=0x00;
	STS  110,R30
; 0000 004F 
; 0000 0050 TIMSK1=0x00;
	STS  111,R30
; 0000 0051 
; 0000 0052 TIMSK2=0x00;
	STS  112,R30
; 0000 0053 
; 0000 0054 UCSR0B=0x00;
	STS  193,R30
; 0000 0055 
; 0000 0056 ACSR=0x80;
	LDI  R30,LOW(128)
	OUT  0x30,R30
; 0000 0057 ADCSRB=0x00;
	LDI  R30,LOW(0)
	STS  123,R30
; 0000 0058 DIDR1=0x00;
	STS  127,R30
; 0000 0059 
