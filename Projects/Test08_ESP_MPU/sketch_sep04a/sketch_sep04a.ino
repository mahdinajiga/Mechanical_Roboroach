...
#define SWAP(x,y) swap = x; x = y; y = swap
  ...
  */
  ...
  accel_t_gyro.value.x_gyro = accel_t_gyro.value.x_gyro * .047;
  accel_t_gyro.value.y_gyro = accel_t_gyro.value.y_gyro * .047;
  accel_t_gyro.value.z_gyro = accel_t_gyro.value.z_gyro * .047;

  Vall += (accel_t_gyro.value.z_gyro*.002);
  Serial.println(Vall);
  /*
